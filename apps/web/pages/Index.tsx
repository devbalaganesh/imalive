              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6 bg-black text-green-400 font-mono text-sm">
                  <div className="space-y-2">
                    <div>$ I'mLivevalidator init</div>
                    <div>Initializing validator node...</div>
                    <div>Connected to I'mLive Hub</div>
                    <div>Validator ID: I'mLive_val_8a72f...</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="font-medium">I'mLive</span>
            </div>
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            © 2025 I'mLive All rights reserved.
          </div>
        </div>
      </footer>
    </div>
